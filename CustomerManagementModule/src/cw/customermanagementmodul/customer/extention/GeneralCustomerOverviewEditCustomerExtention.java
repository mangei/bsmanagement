...
public class GeneralCustomerOverviewEditCustomerExtention
        implements CWIViewExtentionPoint<CustomerOverviewEditCustomerView, CustomerOverviewEditCustomerPresentationModel> {

    private GeneralCustomerOverviewEditCustomerPresentationModel model;
    private GeneralCustomerOverviewEditCustomerView view;

	@Override
	public void initPresentationModel(
			CustomerOverviewEditCustomerPresentationModel baseModel) {
