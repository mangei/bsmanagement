...
public class PrintGebLaufPresentationModel implements Disposable {
    ...
    private void initModels() {
        ...
        setReportSource("./src/cw/boardingschoolmanagement/jasper/templates/bewohner.jrxml");
...
//        JRDataSource tarifDS= new CustomDataSource(bewohnerList, bewohnerTarifSelection.getMap());
        ...
        try {
            subreport=JasperCompileManager.compileReport("./src/cw/boardingschoolmanagement/jasper/templates/gebuehren.jrxml");
